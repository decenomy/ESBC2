Contributing to esbcoin Core
============================

The esbcoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the esbcoin Core project, and is not to be
confused with overall esbcoin Network Protocol consensus changes.

Whether a pull request is merged into esbcoin Core rests with the project merge
...
Patches that change esbcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the esbcoin consensus, it must have been
...
The project leader is the release manager for each esbcoin Core release.
