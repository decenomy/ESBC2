...
Setup
---------
Configuring the github-merge tool for the ESBC repository is done in the following way:

    git config githubmerge.repository ESBC/ESBC
...
A script to optimize png files in the ESBC
