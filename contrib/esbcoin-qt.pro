...
RESOURCES += src/qt/esbcoin.qrc src/qt/esbcoin_locale.qrc

TRANSLATIONS += src/qt/locale/esbcoin_bg.ts \
                src/qt/locale/esbcoin_de.ts \
                src/qt/locale/esbcoin_en.ts \
                src/qt/locale/esbcoin_es.ts \
                src/qt/locale/esbcoin_fi.ts \
                src/qt/locale/esbcoin_fr.ts \
                src/qt/locale/esbcoin_it.ts \
                src/qt/locale/esbcoin_ja.ts \
                src/qt/locale/esbcoin_pl.ts \
                src/qt/locale/esbcoin_pt.ts \
                src/qt/locale/esbcoin_ru.ts \
                src/qt/locale/esbcoin_sk.ts \
                src/qt/locale/esbcoin_sv.ts \
                src/qt/locale/esbcoin_vi.ts \
                src/qt/locale/esbcoin_zh_CN.ts \
                src/qt/locale/esbcoin_zh_TW.ts
