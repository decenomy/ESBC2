...
In order to support loading of multiple wallets in esbcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is esbcoin.cpp.
...
Changes to esbcoin.cpp
----------------------
esbcoin.cpp is the entry point into esbcoin-qt, and as such, will require some minor modifications to provide hooks for
