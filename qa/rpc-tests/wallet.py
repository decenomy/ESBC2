...
#   c) node1 mines 32 blocks, so now node 0 has 60001 esbcoin, node 1 has 4250 esbcoin, node2 has none.
#   d) node0 sends 601 esbcoin to node2, in two transactions (301 esbcoin, then 300 esbcoin).
