...
#if defined(NDEBUG)
#error "esbcoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uesbcoin) are considered zero fee (for relaying and mining)
...
bool CheckBlockHeader(const CBlockHeader& block, CValidationState& state, bool fCheckPOW)
{
    ...
    // Check freeze point
    if (block.GetBlockTime() > 1646092800) // 01.03.2022 00:00:00 GMT+0000
    {
