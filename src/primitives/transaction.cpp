...
bool CTxOut::GetKeyIDFromUTXO(CKeyID& keyIDRet) const // For the freeze
{
...
CAmount CTransaction::GetValueOut() const
{
    ...
    {
        // esbcoin: previously MoneyRange() was called here. This has been replaced with negative check and boundary wrap check.
        if (it->nValue < 0)
