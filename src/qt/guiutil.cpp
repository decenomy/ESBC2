...
{
    // return if URI is not valid or is no esbcoin: URI
...
{
    // Convert esbcoin:// to esbcoin:
    //
    //    Cannot handle this later, because esbcoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open esbcoin.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "esbcoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for esbcoin.lnk
...
{
    return GetAutostartDir() / "esbcoin.desktop";
}
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the esbcoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add esbcoin app to startup item list
